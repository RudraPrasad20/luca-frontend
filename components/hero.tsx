  ...
  return (
    <div className="mt-20">
        <motion.h1
          ...
          className="text-2xl px-4 md:text-4xl m-16 lg:text-5xl font-bold text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto "
        >
